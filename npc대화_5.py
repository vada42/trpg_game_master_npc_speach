...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        **다이스 판정 결과**:
        ...
        ("user", "#Format: {format_instructions}\n\n#npc: {npc}, location: {location}, player_talk: {player_talk}, detail: {detail}, success_or_failure:{success_or_failure}, bonus:{bonus}")
    ] 
)
...
def npc_talking(npcName, userMsg, detail, location, diceResult, bonus):
    query = {
        "npc": npcName,
        "player_talk": userMsg,
        "detail": detail,
